...
当前整理 **263 个插件**，统一归入七个大类。每个插件只出现一次，并按照最主要的使用价值进行分类。最近一次目录复核：**2026 年 9 月 10 日**。
...
这是目录的首个公开快照：共 **263 个插件**、**7 个大类**，中英文条目一一对应。后续新增、移除和修正统一记录在 [CHANGELOG.md](CHANGELOG.md)。
...
- [dsh-goal](https://github.com/GooDAnDReaDY/dsh-goal) — 为 DeepSeek Harness 添加 /goal 命令，运行带里程碑跟踪、代理工具和顶部状态横幅的自主多轮执行循环。
