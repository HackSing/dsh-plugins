...
- [dsh-subscriptions](https://github.com/GooDAnDReaDY/dsh-subscriptions) — 通过 OAuth 将 Codex、Claude、Grok 和 Antigravity 的付费订阅账户接入 DeepSeek Harness，支持多账户轮换并为兄弟插件提供 Cordis 服务。
