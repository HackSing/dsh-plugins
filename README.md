...
- [dsh-cron](https://github.com/GooDAnDReaDY/dsh-cron) — A DeepSeek Harness plugin that schedules cron and interval tasks and runs agent or shell prompts on those schedules.
