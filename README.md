...
- [dsh-gitea](https://github.com/GooDAnDReaDY/dsh-gitea) — DeepSeek Harness plugin that exposes Gitea and Forgejo instance operations as agent tools for issues, pull requests, CI, releases, labels, webhooks, and git worktrees.
