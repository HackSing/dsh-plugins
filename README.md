...
- [dsh-grok-xsearch](https://github.com/GooDAnDReaDY/dsh-grok-xsearch) — DSH plugin that registers X search, author profile, trending topics, and fact-check tools backed by xAI's Responses API.
