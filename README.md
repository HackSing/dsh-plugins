...
- [dsh-context-lens](https://github.com/GooDAnDReaDY/dsh-context-lens) — A DSH plugin that compresses agent context by generating AST code skeletons, filtering test and build logs, and tracking token budget usage.
