...
- [command-scout](https://github.com/JohnXu22786/command-scout) — Scans a project's declared build commands from Makefile, package.json scripts, justfile, and deno tasks and exposes them as agent tools.
