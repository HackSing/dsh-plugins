...
- [dsh-context-lens](https://github.com/GooDAnDReaDY/dsh-context-lens) — Provides DeepSeek Harness agent tools that turn source code into AST skeletons, condense test and build logs, and track token usage against a configurable session budget.
